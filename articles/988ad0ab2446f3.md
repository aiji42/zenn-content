...
この記事では、上で紹介しきれなかった、**CSRなページ・SPAなコンテンツをSGなページに変換して配信する**ということについて紹介していきます。  
前提となる情報は上の記事で述べられているため、まずはそちらをご覧ください。

:::message
この記事では、**コンテンツの現行のコードを、大きく変えることなくスタティックなページとして配信する**ことを目指します。
...
言葉で説明するのは簡単ですが、このアーキテクチャを構築するにあたって、解消すべき課題がいくつかありますのでその方法について触れていきます。
